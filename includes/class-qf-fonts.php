 ...
 * This class is forked from Elementor.
 *
 * @package QuillForms
 * @since 1.0.0
 */
...
class QF_Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = array(
				self::SYSTEM      => __( 'System', 'quillforms' ),
				self::GOOGLE      => __( 'Google', 'quillforms' ),
				self::EARLYACCESS => __( 'Google Early Access', 'quillforms' ),
			);
			 ...
			 */
			$font_groups = apply_filters( 'quillforms_fonts_groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 */
			$additional_fonts = apply_filters( 'quillforms_additional_fonts', $additional_fonts );
