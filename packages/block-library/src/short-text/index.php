 ...
 * @since 1.0.0
 */
class QF_Short_Text extends QF_Block {
	...
	private function get_metadata() {
		if ( ! $this->metadata ) {
			$this->metadata = json_decode(
				file_get_contents( trailingslashit( dirname( __FILE__ ) ) . 'short-text/block.json' ),
				true
			);
		}
...
QF_Blocks_Factory::get_instance()->register( new QF_Short_Text() );
