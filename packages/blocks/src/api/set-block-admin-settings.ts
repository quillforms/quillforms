...
export const blockColors = {
	...
	'welcome-screen': '#E4FAEC', // Softer coral pink (calm and warm)
	'thankyou-screen': '#E4FAEC', // Lighter soft pink (friendly and calm)
	group: '#DAE5F0', // Light lavender (calm and soothing)
	'partial-submission-point': '#DAE5F0', // Light pastel orange (calm and fresh)

	// Uniform color for all other fields
	date: '#F2F4FC', // Soft neutral beige (calm and clean)
	email: '#E2DFFF', // Soft neutral beige (calm and clean)
	dropdown: '#FFEEFB', // Soft neutral beige (calm and clean)
	'multiple-choice': '#FFEEFB', // Soft neutral beige (calm and clean)
	statement: '#E4FAEC', // Soft neutral beige (calm and clean)
	website: '#E2DFFF', // Soft neutral beige (calm and clean)
	'short-text': '#E2DFFF', // Soft neutral beige (calm and clean)
	'long-text': '#E2DFFF', // Soft neutral beige (calm and clean)
	'opinion-scale': '#FFEEFB', // Soft neutral beige (calm and clean)
	slider: '#FFEEFB', // Soft neutral beige (calm and clean)
	'picture-choice': '#FFEEFB', // Soft neutral beige (calm and clean)
	rating: '#FFEEFB', // Soft neutral beige (calm and clean)
	phone: '#E2DFFF', // Soft neutral beige (calm and clean)
	'input-mask': '#E2DFFF', // Soft neutral beige (calm and clean)
	matrix: '#E4DFF3', // Soft neutral beige (calm and clean)
	'cal.com': '#E4DFF3', // Soft neutral beige (calm and clean)
	number: '#E2DFFF', // Soft neutral beige (calm and clean)
	file: '#FBE8E8', // Soft neutral beige (calm and clean)
	'image-upload': '#E4DFF3', // Soft neutral beige (calm and clean)
	signature: '#FBE8E8', // Soft neutral beige (calm and clean)
	'calendar-picker': '#F2F4FC', // Soft neutral beige (calm and clean)
	legal: '#FFEEFB', // Soft neutral beige (calm and clean)
	address: '#E2DFFF', // Soft neutral beige (calm and clean)
};
