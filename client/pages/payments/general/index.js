		...
		<div className="quillforms-payments-page-settings__general">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div className="flex flex-col gap-1.5">
					<h3 className='!m-0 !text-[#334155] !text-base !font-semibold'>{__('General Settings', 'quillforms')}</h3>
				...
				<div className="quillforms-payments-page-settings__general-header-toggle flex flex-col gap-4">
					<BaseControl>
						<ControlWrapper orientation="horizontal">
							<ControlLabel
								label={
									<span className='!m-0 !text-[#334155] !text-sm !p-0 leading-5'>
