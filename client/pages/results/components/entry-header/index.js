	...
	return (
		<>
			...
			<div className="entries-header">
				<div className="entries-header__top-row">
					<div className="entries-header__title">
						{__('Responses', 'quillforms')} ({totalEntries})
					</div>
					<div className="entries-header__filters">
						<span className="entries-header__filter-label">
							{__('Filter By', 'quillforms')}
						</span>
