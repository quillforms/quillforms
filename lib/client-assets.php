...
function quillforms_register_packages_styles( $styles ) {
	...
	quillforms_override_style(
		$styles,
		'quillforms-block-library-editor',
		quillforms_url( 'build/block-library/editor.css' ),
		array(),
		filemtime( quillforms_dir_path() . 'build/block-library/editor.css' )
	);
	$styles->add_data( 'quillforms-block-library-editor', 'rtl', 'replace' );

	// Block Library Renderer.
	quillforms_override_style(
		$styles,
		'quillforms-block-library-renderer',
		quillforms_url( 'build/block-library/renderer.css' ),
		array(),
		filemtime( quillforms_dir_path() . 'build/block-library/renderer.css' )
	);
	$styles->add_data( 'quillforms-block-library-renderer', 'rtl', 'replace' );
	...
	quillforms_override_style(
		...
		array( 'quillforms-renderer-components', 'quillforms-block-library-renderer' ),
